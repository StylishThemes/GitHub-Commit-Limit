# Contributing to GitHub Commit Limit
...
* This style does not have a size limit, but:
  * Don't add any image URI's to the css; instead add the image into the `/images` directory; then point to using the following url: `http://StylishThemes.github.io/GitHub-Commit-Limit/images/{my-image.png}`.
